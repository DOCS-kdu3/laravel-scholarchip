...
class ScholarChipCore
{
    ...
    /**
     * ScholarChip general ledger account (aka sEAGL)
     * @var string
     */
    private $gl;
    ...
    public function __construct(SoapClient $soapClient, $user, $password, $gl)
    {
